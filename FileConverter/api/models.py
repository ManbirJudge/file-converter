...
class ConvertRequest(models.Model):
    ...
    target_fmt = models.CharField(max_length=20, null=False, blank=False)
...
class File(models.Model):
    ...
    request = models.ForeignKey(ConvertRequest, on_delete=models.CASCADE, null=False, blank=False, related_name='files')
